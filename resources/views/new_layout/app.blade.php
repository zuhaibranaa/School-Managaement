            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="ed-com-t1-left">
                        <ul>
                            <li><a href="#">Contact: Superior University.</a>
                            </li>
                            <li><a href="#">Phone: +315-6438000</a>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="top-logo" data-spy="affix" data-offset-top="250">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="wed-logo">
                        <a href="index.html"><img src="images/f-logo.png" alt="" />
                        </a>
                    </div>
                    <div class="main-menu">
                        <ul>
        ...
        <div class="container">
            ...
            <div class="row wed-foot-link-1">
                <div class="col-md-4 foot-tc-mar-t-o">
                    <h4>Get In Touch</h4>
                    <p>Address: Superior University.</p>
                    <p>Phone: <a> +315-6438000</a></p>
                    <p>Email: <a> mcsm@superior.edu.pk</a></p>
                </div>
                <div class="col-md-4">
                    <h4>SOCIAL MEDIA</h4>
                    <ul>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="s12">
                        ...
                        <div>
                            <div class="input-field s12">
                                <input placeholder="E Mail" id="email" data-ng-model="name" type="email" class="validate" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                <label>User name</label>
                            </div>
                        </div>
                        <div>
                            <div class="input-field s12">
                                <input id="Password" placeholder="password" type="password" class="validate" name="password" required autocomplete="current-password">
            ...
            <div class="log-in-pop">
                ...
                <div class="log-in-pop-right">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="s12">
                        ...
                        <div>
                            <div class="input-field s12">
                                <input id="name" data-ng-model="name1" type="text" class="validate" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                <label>User name</label>
                            </div>
                        </div>
                        <div>
